// import { ReactComponent as IconCodeSandbox } from '@firesoon/antd/icons-svg/inline-svg/outlined/code-sandbox.svg';
...
const PreviewerActions: FC<IPreviewerActionsProps> = (props) => {
  ...
  return (
    <>
      <div className="dumi-firesoon-previewer-actions">
        {(props.title || props.debug) && (
          <div className="dumi-firesoon-previewer-desc">
            <a href={props.link}>
        ...
        {/* {!props.disabledActions?.includes('CSB') && (
          <button
            className="dumi-firesoon-previewer-action-btn"
            type="button"
      ...
      {showCode && (
        <>
          <div className="dumi-firesoon-previewer-sources">
            {!isSingleFile && (
              <Tabs
                className="dumi-firesoon-previewer-tabs"
                prefixCls="dumi-firesoon-tabs"
                moreIcon="···"
